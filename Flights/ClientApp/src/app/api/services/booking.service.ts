  ...
  context?: HttpContext
...
): Observable<StrictHttpResponse<BookingRm>> {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<BookingRm>;
      })
    );
  }
...
): Observable<BookingRm> {

    return this.listBooking$Plain$Response(params,context).pipe(
      map((r: StrictHttpResponse<BookingRm>) => r.body as BookingRm)
    );
  }
